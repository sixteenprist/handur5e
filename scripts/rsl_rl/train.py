...
try:
    ...
    _HAS_DEPRECATED_HANDLER = True
except ImportError:
    _HAS_DEPRECATED_HANDLER = False
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    # handle deprecated configurations (版本兼容)
    if _HAS_DEPRECATED_HANDLER:
    ...
    # 锚定到项目根目录（scripts/rsl_rl/../../），避免从不同 CWD 启动时日志分散到各处
